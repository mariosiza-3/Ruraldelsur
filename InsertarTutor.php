...
<div class="kj1">
    <h1 class="kj2">Insertar Tutor</h1>
</div>
<div class="kj3">
    <form name="INSERT" action="InsertarTutor.php" method="POST" enctype="multipart/form-data" >
        <div class="kj4">
            ...
            <div class="kj5">
                <label for="fecha">PARENTESCO:</label><br>
    ...
    if (isset($_POST['ENVIAR'])) {
        ...
        $PARENTEZCO = $_POST['caja5'];   
            ...
            $SQL = "INSERT INTO tutor (Nombre, Apellido, Telefono, CorreoElectronico, Contrasena, Parentezco) VALUES ('$NOMBRE', '$APELLIDO', '$TELEFONO', '$CORREOELECTRONICO', '$CONTRASENA', '$PARENTEZCO');";
            $RESULT = mysqli_query($conexion, $SQL) or die(mysqli_error($conexion));

            echo '<script>alert("Tutor Insertado");</script>';
