...
<div class="kj1">
    <h1 class="kj2">Insertar Psicólogo</h1>
</div>
<div class="kj3">
    <form name="INSERT" action="InsertarPsicologo.php" method="POST" enctype="multipart/form-data" >
        <div class="kj4">
    ...
    if (isset($_POST['ENVIAR'])) {
        ...
        $CONTRASENA = $_POST['caja5'];
            ...
            $SQL = "INSERT INTO psicologo (Nombre, Apellido, Telefono, CorreoElectronico, Contrasena) VALUES ('$NOMBRE', '$APELLIDO', '$TELEFONO', '$CORREO','$CONTRASENA')";
            $RESULT = mysqli_query($conexion, $SQL) or die(mysqli_error($conexion));

            echo '<script>alert("Psicólogo Insertado Exitosamente");</script>';
